...
session_start();
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
    ...
    if($sr_no != 0 && $sr_no === $_SESSION['sr_no'])
    {
      ...
      $query = "update hostel_details set mess_fee = '$mess_fee' ,tv_fund = '$tv_fund', machine_fee = '$machine_fee', est_charges = '$est_charges', caution_deposit = '$caution_deposit', total_fee = '$total_fees' where sr_no = '$sr_no'";
